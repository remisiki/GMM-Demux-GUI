...
def gather_multiplet_rates(venn_values, SSM_rate_ary, sample_num):
    ...
    :param venn_values: List of count by class, generated by :func:`gmmd.classifier.count_by_class`.
    :type venn_values: :class:`list`
    :param SSM_rate_ary: List of SSM rates, generated from :func:`gmmd.estimator.compute_SSM_rate_with_cell_num`.
    :type SSM_rate_ary: :class:`list`
...
def obtain_HTO_GEM_num(data, base_bv_array):
    ...
    :return: A list of HTO numbers for each cell type.
    :rtype: :class:`list`
...
def param_scaling(params, scaler, operator):
    ...
    :param scaler: List of scaler.
    :type scaler: :class:`list`
    :param operator: A function to operate on the parameters.
    :type operator: :class:`func`


    :return: List of scaled parameters.
    :rtype: :class:`list`
...
def obtain_experiment_params(base_bv_array, HTO_GEM_ary, sample_num, estimated_total_cell_num, params0 = None):
    ...
    :param base_bv_array: Binary array with all combinations of cells, generated by :func:`gmmd.compute.obtain_base_bv_array`.
    :type base_bv_array: :class:`list`
    :param HTO_GEM_ary: HTO nmumbers array, generated by :func:`gmmd.compute.obtain_HTO_GEM_num`.
    :type HTO_GEM_ary: :class:`list`
    :param sample_num: Number of samples.
    :type sample_num: :class:`int`
    :param estimated_total_cell_num: Estimated total cell number.
    :type estimated_total_cell_num: :class:`int`
    :param params0: List of parameters.
    :type params0: :class:`list`, Default = ``[{drop_num=}80000, {capture_rate=}0.5, {cell_num_ary=}[{estimated_total_cell_num / sample_num}] * {sample_num}``
