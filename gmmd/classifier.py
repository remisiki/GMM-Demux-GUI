...
def store_full_classify_result(data, class_name_array, path):
    ...
    :type data: :class:`pandas.DataFrame`
    :param class_name_array: All class names, generated by :func:`gmmd.classifer.classify_drops`.
...
def store_simplified_classify_result(data, class_name_array, path, sample_num, confidence_threshold):
    ...
    :param data: Classification result, generated by :func:`gmmd.classifer.classify_drops`.
    :type data: :class:`pandas.DataFrame`
    :param class_name_array: All class names, generated by :func:`gmmd.classifer.classify_drops`.
    :type class_name_array: :class:`list`
    :param path: File path to store the result.
...
def purify_droplets(data, confidence_threshold):
    """Clean droplets with confidence under the threshold.
...
def obtain_SSD_list(data, sample_num, class_id_ary = None):
    ...
    :param data: Purified classification result, generated by :func:`gmmd.classifier.purified_df`.
    :type data: :class:`pandas.DataFrame`
